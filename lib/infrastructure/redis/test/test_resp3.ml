...
let () =
  run "RESP3 Parser Tests" [
    "simple string", simple_string_tests;
    "simple error tests", simple_error_tests;
    "bulk string tests", bulk_string_tests;
    "integer tests", integer_tests;
    "array tests", array_tests;
    "null tests", null_tests;
    "boolean tests", boolean_tests;
    "double tests", double_tests;
    "big number tests", big_number_tests;
    "bulk error tests", bulk_error_tests;
    "verbatim string tests", verbatim_string_tests;
    "map tests", map_tests;
    "attribute tests", attribute_tests;
    "set tests", set_tests;
    "push tests", push_tests;
